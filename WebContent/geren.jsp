...
<div class="Xcontent" >
	<ul class="Xcontent01">
		<div class="Xcontent06">  <img src="images/grxq1.jpg"></div>
		<ol class="Xcontent08">
			<div class="Xcontent07"><img src="images/grxq1.jpg"></div>
			<div class="Xcontent09"><img src="images/grxq2.jpg"></div>
			<div class="Xcontent10"><img src="images/grxq4.jpg"></div>
			<div class="Xcontent11"><img src="images/grxq23.jpg"></div>
		</ol>
		<ol class="Xcontent13">
			<div class="Xcontent14"><a href="#"><p>蓝色水花</p></a></div>
...
<script language="JavaScript" type="text/javascript">
 function panduan(){
	 ...
	 if ("${user}" == ""){
		...
		location.href="${pageContext.request.contextPath}/user_makeAlbum.action?albumId=5";
...
<div id="services" class="services service-section">
  ...
  <div class="section-header">
                ...
                <p class="wow fadeInDown animated">蓝色深海处的传说，赋予你独有的花颜悦容.</p>
            </div>
    <div class="section-display">
	  <span class="service-img"><img src="images/grxq24.jpg" alt="service"/> </span>
    ...
    <div class="section-display">
	  <span class="service-img"><img src="images/grxz25.jpg" alt="service"/> </span>
        <div class="services-content">
          <h4>花颜</h4>
          <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis eu libero scelerisque ligula sagittis faucibus eget quis lacus.</p> -->
        </div>
    ...
    <div class="section-display">
	  <span class="service-img"><img src="images/grxq26.jpg" alt="service"/> </span>
        <div class="services-content">
          <h4>悦色</h4>
         <!--  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis eu libero scelerisque ligula sagittis faucibus eget quis lacus.</p> -->
        </div>
