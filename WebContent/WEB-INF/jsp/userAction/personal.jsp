...
<body>
	...
	<div id="e_background" style="overflow: scroll">
		...
		<div class="container">
			...
			<div class="your-brief-intro" style="position: relative">
				<h3>
					<span class=" fa fa-user-circle"></span> 个人中心
				</h3>
				<p class="your-title">
					<span> <img src="${user.touxiang }" />
					</span> <span class="your-name"> <span class="fa fa-user-o"
						style="color: #CD9B9B;"> 用户名:</span>
					<s:a action="user_editUI" style="cursor:pointer;color:#CD9B9B;"> ${user.name}</s:a>
						<br> <span class="fa fa-bookmark-o"
						style="margin-top: 10px; color: #CD9B9B;"> 积分:</span>123<br>
						<span class="fa fa-rmb" style="margin-top: 10px; color: #CD9B9B;">
							余额:</span>123<br> <span class="fa fa-shopping-cart"
						style="margin-top: 10px; color: #CD9B9B;"><a
							href="${pageContext.request.contextPath}/trolley_list.action"
							target="right" style="color: #CD9B9B;">我的购物车</a></span>
					</span>
				</p>
			...
			<div class="content1">
				<div class="content-photo">
					<h4 style="text-align: center">
						<s:a action="photo_getAllPhotos" style="color:#000;">我的照片</s:a>
					</h4>
								...
								<s:iterator value="#photoList">
									<div class="col-md-4">
										<div class=""
											...
											<img src="/ElectronicAlbum/imgs/${PName}" alt=""
			...
			<div class="content2">
				<div class="content-album">
					<h4 style="text-align: center">
						<s:a action="albumbook_list" style="color:#000;">我的相册</s:a>
					</h4>
									...
									<div class="col-md-4">
										...
										<div class="stack">
											...
											<div class="stack__figure">
												<a href="albumbook_list.action"><img class="stack__img"
													src="${album.coverAddr}" alt="Image"></a>
											</div>
										</div>
	...
	<script>
		...
		function set_spin_class(target, val) {
			for (i = 0; i < 10; i++) {
				if (i != val) {
					rem_class("spinner_" + target, "spinner_" + target + "_"
							+ i);
