...
<div class="payWrap">  
    <div class="payHeader">  
        <strong>订单编号：aaaaaaaaaa</strong>  
        <strong class="fontsize" style="float:right">60.00</strong>
    </div>  
    ...
    <section class="payContent">  
        <div class="unionpayList ">
           ...
           <li>共支付<strong class="fontsize">60.00</strong>元  </li>
           </ul>
        </div>  
   
    </section> 
     <div class="payBorder">  
            <a href="#" class="payBut">确认支付</a>  
